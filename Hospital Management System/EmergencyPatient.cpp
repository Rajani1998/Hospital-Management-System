...
EmergencyPatient::EmergencyPatient(string N,string G,string Ad,string Ph,int Ag,double B):Patient(N,G,Ad,Ph,Ag,B){
...
ostream& operator <<(ostream& output,EmergencyPatient &E){
	...
	output<<endl<<"Patient Blood Group "<<E.getBloodGroup();
